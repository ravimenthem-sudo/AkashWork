...
import {
    ...
    StickyNote, ThumbsUp, ThumbsDown, Download
} from 'lucide-react';
...
const TaskDetailOverlay = ({
    ...
    React.useEffect(() => {
        // Expose active task to global window for Chatbot context
        if (isOpen && task) {
            window._activeTask = task;
        }
        return () => {
            if (window._activeTask?.id === task?.id) {
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ paddingRight: '32px' }}>
                    ...
                    {/* Task Guidance & Specs Section - NEW */}
                    {Object.values(task.phase_validations || {}).some(v => v.guidance_doc_url || v.description) && (
                        <div style={{
                            marginTop: '24px',
                            padding: '24px',
                            backgroundColor: '#f8fafc',
                            ...
                            <div style={{
                                ...
                                {phases.map(p => {
                                    ...
                                    if (!val || (!val.guidance_doc_url && !val.description)) return null;
                                    ...
                                    return (
                                        <div key={p.key} style={{
                                            ...
                                            {val.guidance_doc_url && (
                                                <a
                                                    href={val.guidance_doc_url}
                                                    target="_blank"
                                                ...
                                                >
                                                    <Download size={14} /> View Reference Doc
                                                </a>
                                            )}
                                        </div>
                                    );
