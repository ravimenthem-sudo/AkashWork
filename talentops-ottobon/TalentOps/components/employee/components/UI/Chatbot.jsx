...
const Chatbot = () => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const projectId = projectMatch ? projectMatch[1] : (currentProject?.id || null);
            const taskId = window._activeTask?.id || null;

            // Build chat history for context-aware follow-ups (last 6 messages)
