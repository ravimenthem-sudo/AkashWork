...
import { Briefcase, ChevronRight, LayoutGrid, FolderKanban } from 'lucide-react';
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{
                ...
                <div style={{ position: 'absolute', inset: 0, opacity: 0.1, pointerEvents: 'none' }}>
                    <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <pattern id="mesh-tasks-exec" width="40" height="40" patternUnits="userSpaceOnUse">
                                <path d="M 40 0 L 0 0 0 40" fill="none" stroke="white" strokeWidth="0.5" />
                            </pattern>
                        </defs>
                        <rect width="100%" height="100%" fill="url(#mesh-tasks-exec)" />
                    </svg>
                </div>
            ...
            {loading ? (
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '0.95rem', color: '#64748b', maxWidth: '300px' }}>There are no active projects in the organization.</p>
                </div>
            ) : (
                <div style={{
                    display: 'grid',
